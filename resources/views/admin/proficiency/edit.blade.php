...
@section('page_title', 'Edit proficiency')
...
<div class="page-content fade-in-up">
    ...
    @endif
    <form method="post" action="{{route('proficiency.update', $detail->id)}}" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Edit proficiency</div>
                    </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control" name="title" value="{{$detail->title}}" type="text"
                                    placeholder="Enter proficiency Title">
                            </div>
                        </div>
