    ...
    <div class="col-md-12">
      <div class="ibox">
        ...
        <div class="ibox-body" style="">
          <form method="post" action="{{route('front.branch.store', $detail->id)}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <label>Mobile</label>
                <input name="mobile" value="{{old('mobile')}}" type="text" class="form-control" required
                  placeholder="Mobile">
              </div>
              <div class="col-12">
                <div class="row">
