...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            ...
            <div>
                <a class="btn btn-info btn-md" href="{{route('front.scholarship.create',$detail->id)}}">Add
            ...
            <table id="example-table" class="table table-striped table-bordered table-hover" cellspacing="0"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('front.scholarship.edit', $data->id)}}" class="btn btn-success btn-sm"><i
                                    class="fa fa-edit"></i>
                            </a>
