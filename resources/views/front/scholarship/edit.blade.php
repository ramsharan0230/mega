    ...
    <div class="col-md-12">
      <div class="ibox">
        ...
        <div class="ibox-body" style="">
          <form method="post" action="{{route('front.scholarship.update', $detail->id)}}" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <select name="exhibitor_id" class="form-control">
                  <option selected value="{{$detail->exhibitor->id}}">{{$detail->exhibitor->title}}</option>
                </select>
              </div>
