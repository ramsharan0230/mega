...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            ...
            <div>
                <a class="btn btn-info btn-md" href="{{route('front.datetime.create',$detail->id)}}">Add date and
                    time</a>
            </div>
        </div>
        ...
        <div class="ibox-body">
            <table id="example-table" class="table table-striped table-bordered table-hover" cellspacing="0"
                ...
                <tbody>
                    ...
                    @if($detail->datetimes->count())
                    @foreach($detail->datetimes as $key => $data)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('front.datetime.edit', $data->id)}}" class="btn btn-success btn-sm"><i
                                    class="fa fa-edit"></i>
                            </a>
