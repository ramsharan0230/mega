...
<div class="page-content fade-in-up">
    ...
    @endif
    <form method="post" action="{{route('front.datetime.update', $detail->id)}}" enctype="multipart/form-data">
        @csrf
        @method('put')
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select name="exhibitor_id" class="form-control">
                                    <option selected value="{{$detail->exhibitor->id}}">{{$detail->exhibitor->title}}
                                    </option>
