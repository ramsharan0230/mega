...
<section class="stall-page all-sec-padding">
   <div class="container">
      ...
      <div class="row">
         ...
         {{-- $details -> This contains search data --}}
         @foreach($details as $detail)
         <div class="col-lg-6 col-md-12 col-12">
            <div class="top-stall-wrapper other-stall">
               <a href="{{route('exhibitorDetail',$detail->slug)}}" class="stall-main-image mb-3"><img
                     src="/images/main/{{$detail->exhibition_hall_image}}" alt="{{$detail->title}}"></a>
               <h3 class="mb-3">{{$detail->title}}</h3>
               <p class="mb-3">{{$detail->category->title}}</p>
               <a href="{{route('exhibitorDetail',$detail->slug)}}" class="btn stall-btn">Enter Stall</a>
            </div>
         </div>
         @endforeach
         {{-- search results--}}
      ...
      {{-- All Exhibition Halls will be shown in result page as well --}}
